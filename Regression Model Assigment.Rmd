---
title: "Relationship MPG and Other Variables for mtcars"
author: "Klevin D."
date: "April 27, 2016"
output:
    html_document:
...
We will now build a regression model including variables that also have an influence on mpg. 
```{r, }
data("mtcars")
sort(cor(mtcars)["mpg",])
```
We notice that disp and cyl are closely correlate and thus choose to ignore disp.
